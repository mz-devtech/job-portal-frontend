  ...
  const menuItems = [
    {
      section: "Dashboard",
      items: [
        { href: "/overview", icon: <FiGrid size={18} />, label: "Overview", badge: null },
        { href: "/applied_jobs", icon: <FiBriefcase size={18} />, label: "Applied Jobs", badge: "12" },
        { href: "/favourite_jobs", icon: <FiHeart size={18} />, label: "Favorite Jobs", badge: "8" },
        // { href: "/candidate/job-alerts", icon: <FiBell size={18} />, label: "Job Alerts", badge: "3" },
      ]
    },
    ...
    
    {
      section: "Settings",
      items: [
        { href: "/settings", icon: <FiSettings size={18} />, label: "Settings", badge: null },
      ]
    }
  ];
