                      ...
                      >
                        <td className="px-3 sm:px-4 md:px-6 py-3 sm:py-4">
                          <div className="flex gap-2 sm:gap-3 md:gap-4">
                            <div
                              className={`flex h-8 w-8 sm:h-9 sm:w-9 md:h-10 md:w-10 items-center justify-center rounded-lg ${getLogoBgColor(companyName)} text-white font-bold flex-shrink-0 shadow-md group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 text-xs sm:text-sm`}
                            >
                              {getCompanyInitial(companyName)}
                            </div>
