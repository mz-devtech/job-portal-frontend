...
import { Briefcase, Bookmark, Bell, Calendar, Loader2, Sparkles, TrendingUp, Award, ArrowRight, CheckCircle, Clock } from "lucide-react";
...
export default function CandidateMain() {
  ...
  return (
    <main className="mt-4 w-full min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 px-3 sm:px-4 md:px-6 py-4 sm:py-6 md:ml-[260px] md:w-[calc(100%-260px)] md:h-[calc(100vh-7rem)] md:overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 relative pb-20 md:pb-6">
      {screenSize !== 'mobile' && (
        <>
            ...
            <table className="min-w-[500px] sm:min-w-[600px] w-full text-[8px] sm:text-xs">
              ...
              <tbody className="divide-y divide-gray-100">
                {recentApplications.map((app) => (
                  <tr key={app._id} className="group hover:bg-gradient-to-r hover:from-blue-50/50 hover:to-purple-50/50 transition-all duration-300 cursor-pointer">
