      ...
      <div className="w-full max-w-md mx-auto">
        ...
        <div className="animate-scaleIn">
          <div className="mb-8">
            <Link 
              href="/login" 
              className="inline-flex items-center text-blue-600 hover:text-blue-700 transition-all duration-300 group mb-6"
            >
          ...
          <div className="text-center">
            ...
            <div className="relative mx-auto w-24 h-24 mb-6">
              ...
              <div className="relative flex items-center justify-center h-24 w-24 rounded-full bg-gradient-to-br from-green-100 to-emerald-100 mx-auto animate-bounceIn">
                <CheckCircle className="h-12 w-12 text-green-600" />
              </div>
              <Sparkles className="absolute -top-2 -right-2 w-5 h-5 text-yellow-400 animate-pulse" />
            </div>

            <h2 className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-3 flex items-center justify-center gap-2">
              Check Your Email
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-6 animate-slideDown">
            ...
            <button
              ...
              className="group inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-medium hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 transform hover:scale-105 hover:shadow-xl"
            >
              Try again
      ...
      <div className="mb-8">
        ...
        <div className="text-center animate-fadeInDown">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r from-blue-100 to-indigo-100 mb-4 group hover:scale-110 transition-transform duration-300">
            <Mail className="w-8 h-8 text-blue-600 group-hover:rotate-12 transition-transform duration-300" />
          </div>
